<template>
  <kinesis-container :class="['aldea__menu', explode && 'explode']">
    <div
      @click="toggleSound"
    ...
    <nav>
      <ul>
        ...
        <li
          ...
          @mouseover="sound && pyramidSound && playSound('contenido', 'aldea')"
        >
        ...
        >
          <kinesis-element :strength="30" tag="a" href="#section-sesiones">
            <span class="aldea__item-text">{{ $t("sections.sessions") }}</span>
          </kinesis-element>
        </li>
        <li
